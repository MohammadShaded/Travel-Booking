...
export const hotelFormConfig: FormConfig<AdminHotel, CreateHotelRequest, UpdateHotelRequest> = {
    ...
    fields: [
        ...
        { name: 'starRating' as keyof AdminHotel, label: 'Star Rating', type: 'number', required: true, placeholder: '1-5', validate: (v) => (Number(v) < 1 || Number(v) > 5 ? 'Must be 1-5' : undefined) },
